...
class _OnboardingLoginScreenState extends State<OnboardingLoginScreen> {
  ...
  String _generatedOtpCode = '551010';
  ...
  void _sendOtpCode() {
    ...
    final code = phone == '8884070557' ? '551010' : (100000 + (phone.hashCode % 900000).abs()).toString();
    setState(() {
      _phoneError = null;
      _isLoading = true;
      _generatedOtpCode = code;
    });
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: const [
                        Icon(Icons.mark_email_read, size: 16, color: Color(0xFF059669)),
                        SizedBox(width: 6),
                        Text(
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Dispatched to +91 $_tempPhoneNumber',
                    ...
                    Container(
                      ...
                      child: Text(
                        'Verification Code: $_generatedOtpCode (or 551010 / 123456)',
